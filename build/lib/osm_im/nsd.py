...
class yc_nsd_nsd__nsd_catalog_nsd(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__id','__name','__short_name','__vendor','__vendor_specific','__logo','__description','__version','__connection_point','__scaling_group_descriptor','__vnffgd','__ip_profiles','__ns_configuration','__input_parameter_xpath','__parameter_pool','__key_pair','__user','__vld','__constituent_vnfd','__placement_groups','__vnf_dependency','__monitoring_param',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__short_name = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="short-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:etsi:osm:yang:nsd', defining_module='nsd', yang_type='string', is_config=True)
    self.__vendor = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="vendor", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:etsi:osm:yang:nsd', defining_module='nsd', yang_type='string', is_config=True)
    self.__vendor_specific = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="vendor-specific", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:etsi:osm:yang:nsd', defining_module='nsd', yang_type='string', is_config=True)
  ...
  def _get_vendor_specific(self):
    """
    Getter method for vendor_specific, mapped from YANG variable /nsd_catalog/nsd/vendor_specific (string)

    YANG Description: Vendor-specific info of the NSD.
    """
    return self.__vendor_specific
      
  def _set_vendor_specific(self, v, load=False):
    """
    Setter method for vendor_specific, mapped from YANG variable /nsd_catalog/nsd/vendor_specific (string)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="vendor-specific", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:etsi:osm:yang:nsd', defining_module='nsd', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vendor_specific must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="vendor-specific", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:etsi:osm:yang:nsd', defining_module='nsd', yang_type='string', is_config=True)""",
        })
...
network service.
  ...
  _pyangbind_elements = OrderedDict([('id', id), ('name', name), ('short_name', short_name), ('vendor', vendor), ('vendor_specific', vendor_specific), ('logo', logo), ('description', description), ('version', version), ('connection_point', connection_point), ('scaling_group_descriptor', scaling_group_descriptor), ('vnffgd', vnffgd), ('ip_profiles', ip_profiles), ('ns_configuration', ns_configuration), ('input_parameter_xpath', input_parameter_xpath), ('parameter_pool', parameter_pool), ('key_pair', key_pair), ('user', user), ('vld', vld), ('constituent_vnfd', constituent_vnfd), ('placement_groups', placement_groups), ('vnf_dependency', vnf_dependency), ('monitoring_param', monitoring_param), ])
